...
This first module is for selecting dataset. Users can either select from pre-loaded example datasets or upload their own dataset in a pre-defined format as detailed in section 2.1 and in our GitHub page ([https://github.com/interactivereport/Quickomics](https://github.com/interactivereport/Quickomics){target="_blank"}). We have pre-loaded four datasets from published studies that users can use for demonstrative purposes. These includes two RNAseq datasets from [Gyoneva et al., 2019](https://www.life-science-alliance.org/content/2/6/e201900453){target="_blank"} and [Connor-Robson et al., 2019](https://www.sciencedirect.com/science/article/pii/S0969996119300968?via%3Dihub){target="_blank"}; and two proteomics datasets from Connor-Robson et al., 2019. Users can walk through multiple sub-tabs to visualize, select and download figures or data.

[![](https://interactivereport.github.io/Quickomics/tutorial/Figures/FigureS2_1.png)](https://interactivereport.github.io/Quickomics/tutorial/Figures/FigureS2_1.png)

## Upload Files

For a data set, the "Upload Files" tool allows users to upload three required files, namely sample metadata, normalized expression data and statistical comparison results in csv format (Comma Separated Values) to Quickomics directly. Example data sets are provided in GitHub for both RNAseq ([https://bit.ly/2MRkFcb](https://bit.ly/2MRkFcb){target="_blank"}) and proteomics ([https://bit.ly/3rn4i6a](https://bit.ly/3rn4i6a){target="_blank"}). Detailed formatting guidance is outlined below,
...
[![](https://interactivereport.github.io/Quickomics/tutorial/Figures/FigureS2.1_1.png)](https://interactivereport.github.io/Quickomics/tutorial/Figures/FigureS2.1_1.png)
...
[![](https://interactivereport.github.io/Quickomics/tutorial/Figures/FigureS2.3_1.png)](https://interactivereport.github.io/Quickomics/tutorial/Figures/FigureS2.3_1.png)
...
[![](https://interactivereport.github.io/Quickomics/tutorial/Figures/FigureS2.4_1.png)](https://interactivereport.github.io/Quickomics/tutorial/Figures/FigureS2.4_1.png)
...
[![](https://interactivereport.github.io/Quickomics/tutorial/Figures/FigureS2.5_1.png)](https://interactivereport.github.io/Quickomics/tutorial/Figures/FigureS2.5_1.png)
...
[![](https://interactivereport.github.io/Quickomics/tutorial/Figures/FigureS2.6_1.png)](https://interactivereport.github.io/Quickomics/tutorial/Figures/FigureS2.6_1.png)

## Protein Gene Names

This tab contains all quantified gene or protein IDs and gene names.

[![](https://interactivereport.github.io/Quickomics/tutorial/Figures/FigureS2.7_1.png)](https://interactivereport.github.io/Quickomics/tutorial/Figures/FigureS2.7_1.png)
...
[![](https://interactivereport.github.io/Quickomics/tutorial/Figures/FigureS2.8_1.png)](https://interactivereport.github.io/Quickomics/tutorial/Figures/FigureS2.8_1.png)
