...
The “Volcano Plot (Static)” described in Section 4.1 and “Volcano Plot (Interactive)” described in Section 4.2 are ways to visualize each pair-wise comparison one by one. “DEGs/DEPs in Two Comparisons” described in Section 4.3 is a novel way to visualize the similarities and differences in two comparisons. Finally, “Data Table” described in Section 4.4 displays a searchable table containing all genes and their fold changes and P values in each comparison.
...
[![](https://interactivereport.github.io/Quickomics/tutorial/Figures/FigureS4.3_2.png)](https://interactivereport.github.io/Quickomics/tutorial/Figures/FigureS4.3_2.png)
...
[![](https://interactivereport.github.io/Quickomics/tutorial/Figures/FigureS4.3_3.png)](https://interactivereport.github.io/Quickomics/tutorial/Figures/FigureS4.3_3.png)
