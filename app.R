			  ...
			  column(width=12,uiOutput("selectGroupSampleQC")),
				...
				conditionalPanel("input.groupplot_tabset=='PCA Plot'",
				  selectInput("PCAsizeby", label="Size By", choices=NULL),
					...
					selectInput("PCAcolpalette", label= "Select palette", choices=c("Accent"="Accent","Dark2"="Dark2","Paired"="Paired","Pastel1"="Pastel1","Pastel2"="Pastel2","Set1"="Set1","Set2"="Set2","Set3"="Set3", "NPG"="npg", "AAAS"="aaas", "NEJM"="nejm", "Lancet"="lancet", 
		"JAMA"="jama", "D3"="d3", "Uchiago"="uchicago"), selected="Dark2"),
           ...
           column(3,
                  wellPanel(
                    ...
                    conditionalPanel("input.expression_tabset=='Searched Expression Data' | input.expression_tabset=='Browsing' ",
                                     ...
                                     conditionalPanel("input.colorby!='None'",
                                                      selectInput("colpalette", label= "Select palette", choices=c("Accent"="Accent","Dark2"="Dark2","Paired"="Paired",
                                                      "Pastel1"="Pastel1","Pastel2"="Pastel2","Set1"="Set1","Set2"="Set2","Set3"="Set3", "NPG"="npg", "AAAS"="aaas", 
                                                      "NEJM"="nejm", "Lancet"="lancet", "JAMA"="jama", "D3"="d3", "Uchiago"="uchicago"), selected="Dark2")),
                  ...
                  wellPanel(
                    ...
                    conditionalPanel( "input.heatmap_tabset=='Static Heatmap Layout 1'",
                                      ...
                                      conditionalPanel("input.heatmap_more_options=='Yes'",
                                          ...
                                          conditionalPanel("input.heatmap_highlight=='Yes'", uiOutput("gene_highlight_file") ),
