			...
			wellPanel(
			  ...
			  column(width=12,uiOutput("selectGroupSampleQC")),
				...
				conditionalPanel("input.groupplot_tabset=='AlignQC'",
				  ...
				  conditionalPanel("input.AlignQC_tabset=='Top Gene List'",
					  sliderInput("alignQC_TG_Ngene", "Max # of Top Genes Per Sample:", min = 1, max = 100, step = 5, value = 30), 
	...
	fluidRow(
		column(3,
			wellPanel(
				...
				#checkboxInput("HM_comp2sample", "Get Samples from Comparison?",  FALSE, width="90%"),
